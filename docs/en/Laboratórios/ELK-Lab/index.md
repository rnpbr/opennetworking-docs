...
The primary objective of the `elk-lab` is to simulate the sending and analysis of IPFIX traffic flows in a topology of three interconnected routers (GO, MS, and MT), utilizing OSPF for dynamic routing and Elastic Stack tools for real-time observability and traffic analysis.
...
The `elk-lab` can be applied to various educational and research contexts, enabling the simulation of real-world scenarios of traffic export and analysis with the Elastic Stack.
...
The minimum hardware and software requirements to run the lab are listed below. Make sure to include essential tools such as **Containerlab** and **Docker**, in addition to the `br-lab` network. To learn more about these items, visit: [Getting Started - preparing the environment](../../Ferramentas/Primeiros passos - preparando o ambiente.md).

And have the ELK stack pre-installed, to learn more about installing Zabbix, visit: [ELK Installation](../../Ferramentas/Elasticsearch/index.md)
...
To configure data collection using IPFIX, use our [IPFIX configuration guide](../../Ferramentas/Elasticsearch/Configurando IPFIX no ELK.md).