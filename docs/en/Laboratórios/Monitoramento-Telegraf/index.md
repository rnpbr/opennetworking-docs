...
*   The `br-lab` external network connects the nodes to the monitoring infrastructure.
...
*   **Metrics visualization with Grafana**: Supports studies of performance, bottlenecks, and network utilization peaks.
...
And have the Telegraf stack pre-installed. To learn more about Zabbix installation, access: [Telegraf Installation](../../Ferramentas/Telegraf/index.md)
...
!!! tip "Tip"
    On Linux/Mac, use `chmod +x get.sh` before executing the script if it does not have execution permission.
