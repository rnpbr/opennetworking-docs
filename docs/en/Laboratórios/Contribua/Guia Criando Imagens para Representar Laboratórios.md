...
This guide teaches you how to create images representing network topologies for labs, using the [Draw.io](http://draw.io/) template provided in the repository. Images should follow the project's visual identity and be saved in **SVG** format within the correct folder.

---

### 1. **Opening the Template**

In the repository root `docs/Templates`, you'll find a [**Draw.io**](http://draw.io/) template, which you can see below. Open the file and you will see that it already contains all the necessary components to create network topologies, including:
...
2. **Add IP Property**:
    ...
    - Click on **Add Property**, name it **ip**, and add the interface's IP address.
