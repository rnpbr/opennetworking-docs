...
* **Visualization of metrics with Grafana**: Supports performance studies, bottlenecks, and network utilization peaks.
...
!!! warning "Attention"
    Check that your processor has **hardware virtualization support** and that this feature is **enabled in the BIOS/UEFI**.
