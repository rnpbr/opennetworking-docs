...
1. Make sure you have Docker and Docker Compose installed on your machine. If you don't have them yet, you can find them at the following links:
...
**Obs.**: Changes between distant versions can cause errors, look for the correct versions at [https://github.com/netbox-community/netbox-docker/releases](https://github.com/netbox-community/netbox-docker/releases)
...
9. Open your web browser and access: **[http://localhost:8000/](http://localhost:8000/)**.
...
4. On your local computer, open your web browser and access:
...
![**Figure 2**: click on the circuit (left arrow), then select the Circuit ID (highlighted and indicated with the arrow) to perform the configuration.](../../../img/netbox_imgs/circuitID.png)
**Figure 2**: click on the circuit (left arrow), then select the Circuit ID (highlighted and indicated with the arrow) to perform the configuration.

- After clicking on one of the circuits, the circuit settings are similar to those presented in Figure 3. The terminations must be edited by clicking on the `Edit` icon as highlighted in the image below. By clicking on the icon, Netbox forwards to the Cables part in Connections, as shown in Figure 4.
...
- Figure 4 presents the creation of the connection cables, the numbering of the cables only follows the creation order. The `Side*` and `Interface*` items must be filled in to finalize the configuration of step 7.

![Figure 4: cable configuration screen for connection for connection between devices.](../../../img/netbox_imgs/circuitCable.png)
**Figure 4:** cable configuration screen for connection for connection between devices.
