...
These templates use the Jinja2 markup language to process variables and render configuration files based on information stored in the NetBox database.
...
!!! warning "Warning"
    If the repository is private, add your authentication method to the backend parameters.
