...
* A new file will be opened with a basic structure for defining nodes and links.
...
* A graphical visualization (TopoViewer) will be opened showing:
...
The Containerlab extension can be used in conjunction with the VS Code **Remote - SSH**, enabling complete remote use.
