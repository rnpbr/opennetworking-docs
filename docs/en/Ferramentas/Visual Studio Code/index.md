...
3. Or go directly to: <a href="https://marketplace.visualstudio.com/items?itemName=srl-labs.vscode-containerlab" target="_blank">Containerlab Extension</a>.
...
* In the sidebar view, right-click on a topology.
...
The Containerlab extension can be used in conjunction with the VS Code **Remote - SSH**, enabling complete remote usage.
...
5. After connecting:
   ...
   * Use the extension normally with remote topologies.

---

## :material-book-search-outline: Official Documentation

* <a href="https://containerlab.dev/" target="_blank">Containerlab official documentation</a>
