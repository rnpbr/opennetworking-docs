...
In this guide, we'll cover the first steps to prepare the monitoring environment using the Docker network br-lab.
...
eliminating the need for reconfiguration with each new environment. This simplifies testing multiple configurations
and allows the use of various analysis tools more efficiently.
...
- **Flexible Integration**: Allows easily adding new laboratories and devices to the network without impacting the existing infrastructure.

---

### :octicons-graph-24: **Examples of Laboratories That Use the br-lab Network**
...
### :gear: **Explanation of Parameters:**
...
!!! warning "Attention"
    When using static IPs, make sure to use IPs after `172.10.10.100` to avoid conflicts with existing containers.
...
### :material-lan-connect: **Explanation of Connections:**
...
With this guide, you learned how to create and use the Docker network `br-lab`, how to add containers to the network, and how to connect routers virtually. This configuration is ideal for efficient monitoring in laboratory environments.