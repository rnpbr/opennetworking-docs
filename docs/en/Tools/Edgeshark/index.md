...
=== "Using Bash"
    ...
    !!! warning "WARNING"
        The following quick deployment will expose TCP port 5001 to clients external to your host. Make sure your network is properly secured.
...
If you need to capture live network traffic within containers, you need to install the external [cshargextcap](https://github.com/siemens/cshargextcap) plugin for Wireshark.
