...
2. In this tab, you will see a list of available integrations for the agent.
...
After selecting the integration, a brief summary explaining what this integration does will be displayed. Click on **Add NetFlow Records** to proceed.
...
- **Reception Portal**: The portal through which the data will be received.
