...
3. **Synchronization with Netreplica**: **Netreplica** synchronizes the information from **Netbox** via API and generates YAML configurations.
...
- [Edgeshark](Ferramentas/Edgeshark/index.md): Tool for capturing and viewing network traffic
