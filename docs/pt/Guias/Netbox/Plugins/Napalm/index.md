...
Para testarmos o plugin do Napalm, precisamos de dispositivos para consulta, para isso, vamos usar o laboratório de Descoberta [Mais informações](../../../../Laboratórios/Lab%20Descoberta/index.md). Logo, adicionar pelo menos um dispositivo ao Netbox.
