...
O objetivo deste laboratório é demonstrar, de forma prática, o processo de importação automatizada de dispositivos de rede e suas respectivas configurações para o Netbox, utilizando o diodo-plugin, o diode-server e o ora-agent.
